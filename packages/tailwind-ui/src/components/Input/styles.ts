...
const inputCommonStyles =
  'block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset text-grayScheme-900 dark:text-white placeholder:text-grayScheme-400 dark:placeholder:text-grayScheme-600 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 dark:bg-grayScheme-50/5 ring-grayScheme-300 dark:ring-grayScheme-50/10';
