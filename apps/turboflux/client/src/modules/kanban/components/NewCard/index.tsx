          ...
          >
            {({ open }) => (
              <>
                ...
                <div className="relative">
                  <Listbox.Button className="relative inline-flex items-center whitespace-nowrap rounded-full bg-gray-50 px-2 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 sm:px-3 dark:hover:bg-zinc-800 dark:bg-zinc-900 dark:text-zinc-400 dark:border-zinc-700 dark:border dark:hover:text-white">
                    <TagIcon
                      className={classNames(
                        labelled.value === null
                          ? 'text-gray-300'
